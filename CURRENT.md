...
1. **T31 on canto: `ssh home@canto`.** uid 1, `HOME=/home`, sudo ALL
   ...
   before modifiers**; `/oath/store/pkg/sola/libexec/sola-kvm` hand-copied
   this boot, oath-sola `d9cb9311`).
