...
| objects | Typed object store | partial | freeze | QEMU | host/svc/snap/pkg/net; no dev | [catalog](manual/catalog.md) |
...
| pkg | Package objects | partial | [freeze](specs/2026-08-29-pkg-base.md) | QEMU probe | four pkgs; no deps/fetch; busybox not coreutils-identity | [packages](manual/packages.md) |
| net | Network objects | partial | [freeze](specs/2026-08-29-net.md) | QEMU probe ping/undo/reboot | one NIC, static only; no DHCP/SSH/fetch | [network](manual/network.md) |
