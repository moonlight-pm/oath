...
| sola | Sola session on Oath | partial | [freeze](specs/2026-08-31-sola-terminal.md) | QEMU probe + canto HDMI (amdgpu Pitcairn, pixman, 1920×1080@75) | session stack packed; kit seed fonts in `pkg:sola` (SF Pro Text + Iosevka Term Slab; Inter / JetBrains Mono fallbacks); `run-compositor` picks the connected DRM card; sola-river picks the mode matching physical aspect (DualUp 2560×2880@30 vs 4K@60); software GL; no amdgpu accel; other kit apps out; no dbus | [services](manual/services.md) |
