...
| boot | Kernel + init + QEMU | partial | [plan](plans/2026-08-27-qemu-skeleton-plan.md) | `cargo make run` / `probe` | borrowed kernel; Wayland is T21 (not packed) | [qemu](manual/qemu.md) |
...
| sola | Sola session on Oath | spec’d | [freeze](specs/2026-08-30-sola.md) | — | River `pkg`/`svc` not packed; no glibc runtime object; full session out | no |
