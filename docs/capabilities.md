...
| sola | Sola session on Oath | partial | [freeze](specs/2026-08-30-oath-sola.md) | QEMU probe sola.bus / sola.call / sola.bridge / sola.shell | session stack packed (flower + McMojave cursor); Quit Sola is clean exit (`on-failure`); no nested PM; no udevd; full apps out; no dbus; software GL | [services](manual/services.md) |
