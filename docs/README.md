...
| [`specs/2026-09-05-arcade-steam.md`](specs/2026-09-05-arcade-steam.md) | T37 Arcade + Steam runtime (`pkg:bash` / `pkg:xwayland` / `pkg:gamescope` / `pkg:mesa` / `pkg:steam`) | **Target** (canto gen 21; nest window in via `libdecor-oath`) |
