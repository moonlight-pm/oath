...
Apple is still a gap. QEMU probe stays. T33 off-box backup is **partial**
(one NFS send of a generation, overwrite, no retention; canto gen 16
on nas `alpha/backup/canto`).
